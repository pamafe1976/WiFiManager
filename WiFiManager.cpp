/**************************************************************
   ...
   configuration and reconfiguration of WiFi credentials using a Captive al
   inspired by:
...
boolean WiFiManager::autoConnect(char const *apName, char const *apPassword) {
  ...
  if (connectWifi("Optica","") == WL_CONNECTED)   {
...
int WiFiManager::connectWifi(String ssid, String pass) {
  ...
  if (ssid != "") {
    ...
    if (pass != "")
      ...
      DEBUG_WM(F("Conectando a Open"));
      res = WiFi.begin(ssid.c_str());
    }
    if(res != WL_CONNECTED){
